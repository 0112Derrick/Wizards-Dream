...
class UtilFunctions {
    ...
    checkIfObjectMeetsCharacterDataInterface(object, testing = false) {
        ...
        let direction, unlockedSkills, hotbar, name, xVelocity, yVelocity, username, _class, characterGender, width, height, location, attributes, guild, items, player, friends, equipment, x, y, sprite = false;
