...
exports.LANDING_HTML_IDS = exports.HTML_IDS = void 0;
var HTML_IDS = {
    GAME_CHAT: 'chat',
    GAME_CHAT_INPUT: 'say',
...
exports.LANDING_HTML_IDS = SIGNUP_HTML_IDS;
for (var prop in SIGNUP_HTML_IDS) {
    Object.defineProperty(SIGNUP_HTML_IDS, prop, { configurable: false, writable: false });
}
for (var prop in HTML_IDS) {
