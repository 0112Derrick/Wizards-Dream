...
export class GameRouter {
    ...
    initGame(_socket, _ip) {
        ...
        _socket.on("characterCreated", (character, map, clientID) => gameRouter.addCharacterToOverworld);
    ...
    addCharacterToOverworld(character, overworldMap = MapNames.GrassyField, clientID) {
        let gameRouter = GameRouter.GameRouterInstance;
        let overworld = gameRouter.getOverworld();
