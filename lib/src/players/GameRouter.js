...
export class GameRouter {
    ...
    setClient(_client, ip) {
        ...
        this.client = gameRouter.clientInitMap.get(ip);
    }
    getClient(_client, ip) {
        let gameRouter = GameRouter.GameRouterInstance;
        if (gameRouter.clientInitMap.has(ip)) {
    ...
    initGame(_gameSocket) {
        ...
        if (this.clientIP != _gameSocket.request.connection.remoteAddress)
            this.setClientIP(_gameSocket.request.connection.remoteAddress);
